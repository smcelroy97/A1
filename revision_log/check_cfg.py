...
with open('old_cfg.json', 'r') as fptr:
    lhs = json.load(fptr)['simConfig']

with open('new_cfg.json', 'r') as fptr:
    rhs = json.load(fptr)['simConfig']
...
df.to_csv('diff_cfg.csv', index=False)