...
Subnet experiment: `batch_i_ou_subnet_wmult_0.05_all_4_3s_6pts` \
...
Working folder:
`model_tuner/test_data/main/test_subnet_opt_A1/i_ou_wmult_0.05_4`
...
Inbibitory current ramp added during the first 1 second to suppress the transients.