...
It seems that these cells need a long time to stabilize, so the actual firing rate is higher than the target (7 vs 5 Hz).

In this exp, we deliver an external stimulus in the very beginning to speed-up the convergence.
