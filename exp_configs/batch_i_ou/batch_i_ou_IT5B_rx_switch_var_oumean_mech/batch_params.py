...
def get_batch_params():
    ...
    params = {
        ...
        #'ou_ramp_offset': [0.5, 0.75, 1, 1.5, 2],
        'ou_ramp_offset': [0.5, 0.75, 1, 2, 3],
        #'bkg_spike_inputs.IT5B.r': [50, 75, 100, 125, 150],
        #'bkg_spike_inputs.IT5B.r': [50, 75, 100, 150],
        'bkg_spike_inputs.IT5B.r': [75, 100, 150, 200],
        #'bkg_spike_inputs.IT5B.w': [0.1, 0.25, 0.5, 0.75],
        'bkg_spike_inputs.IT5B.w': [0.25, 0.5, 0.75, 1],
        #'mech_var': ['gkdr', 'gnax'],
        #'mech_var': ['gcal', 'gcan', 'gcat'],
        'mech_var': ['gkdr_all'],
