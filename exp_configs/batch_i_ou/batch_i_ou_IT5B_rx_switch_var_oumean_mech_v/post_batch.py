...
def post_batch(exp_name):
    ...
    V0 = batch_utils.collect_batch_xr_data(
        job_idx_xr, dirpath_exp / 'vstats', 'vstats_{job:05d}_*.nc'
    )
    V0.to_netcdf(dirpath_comb / 'vstats_all.nc')
...
if __name__ == '__main__':
    exp_name = 'batch_i_ou/batch_i_ou_IT5B_rx_switch_var_oumean_mech_v'
    post_batch(exp_name)
