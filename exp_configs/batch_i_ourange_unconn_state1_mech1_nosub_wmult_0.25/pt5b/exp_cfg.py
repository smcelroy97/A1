...
def apply_exp_cfg(cfg):
    ...
    # Populations to use
    pops_active = [BATCH_PARAMS['pop_name']]
...
def post_run(sim):
    ...
    ou_mean = cfg.ou_pop_inputs[pop]['ou_mean']
    postfix = (f'{exp_id}_oumean_{(100 * ou_mean):.02f}')
    ...
    t_limits = (BATCH_PARAMS['tcalc_min'], cfg.duration / 1000)
